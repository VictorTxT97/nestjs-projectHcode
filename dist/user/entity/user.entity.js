...
__decorate([
    (0, typeorm_1.Column)({
        type: "enum",
        enum: role_enums_1.Role, // Usa o enum para restringir os valores permitidos
        default: role_enums_1.Role.USER, // Define o valor padrão como `USER`
    }),
    __metadata("design:type", String)
], UserEntity.prototype, "role", void 0);
exports.UserEntity = UserEntity = __decorate([
    (0, typeorm_1.Entity)('users') // Define explicitamente o nome da tabela
], UserEntity);
